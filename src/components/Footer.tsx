...
import { IconProps, Page } from "@component/types";
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        ...
        <SocialLink href="https://twitter.com/geonodecom" icon={TwitterIcon}>
          Follow us on Twitter
        </SocialLink>
        <SocialLink
          href="https://www.linkedin.com/company/geonode/"
          icon={BsLinkedin}
        >
